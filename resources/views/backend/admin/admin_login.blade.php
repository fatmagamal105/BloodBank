...
<head>
    ...
    <link id="base-style-responsive" href="{{asset('backend/css/style-responsive.cs')}}s" rel="stylesheet">
    ...
    <!-- start: Favicon -->
    <link rel="shortcut icon" href="{{URL::to('backend/image/favicon.ico')}}">
    <!-- end: Favicon -->

    <style type="text/css">
        body { background: url({{URL::to('backend/image/bg-login.jpg')}}) !important; }
    </style>
        ...
        <div class="row-fluid">
            <div class="login-box">
                ...
                <p class="alert-danger">
                    <?php
                    $messege = \Illuminate\Support\Facades\Session::get('msg');
                    if($messege)
                    {
                        echo $messege;
                ...
                <form class="form-horizontal" action="{{ url('/admin-login')}}" method="POST">
                    ...
                    <fieldset>
                        ...
                        <div class="input-prepend" title="Email">
                            ...
                            <input class="input-large span10" name="email" type="email" placeholder="email address"/>
                        </div>
